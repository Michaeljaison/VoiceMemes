 ...
 */
@SuppressLint("NewApi") public class TabIndicator extends HorizontalScrollView implements Animator.AnimatorListener {
    ...
    public TabIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        mUnderLineColor = Color.parseColor("#FDD45A");
    ...
    private void addTab(int index, int width, String title) {
        ...
        new Helvetico().overrideFonts(getContext(), tabView);
    ...
    private class TabContainer extends LinearLayout {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (mCurrentTab != null) {
                ...
                for (TabView tabView : mTabList) {
                    tabView.setTextColor(mTextColor);
                    tabView.setBackgroundColor(getResources().getColor(R.color.colorTab));
                }
                mCurrentTab.setTextColor(mTextSelectedColor);
                mCurrentTab.setBackgroundColor(Color.parseColor("#ffb931"));
                int x;
