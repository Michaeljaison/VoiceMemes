...
public class FloatingEditText extends AutoCompleteTextView {
    ...
    @SuppressLint("NewApi") public FloatingEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mHighlightedColor = Color.parseColor("#99091725");
